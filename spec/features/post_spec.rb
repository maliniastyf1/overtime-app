...
describe 'navigate' do
  ...
  describe 'edit' do
    before do
      @edit_user = User.create(email: "adam22@test.com", password: "qwerty", password_confirmation: "qwerty", first_name: "Adam", last_name: "Malyn")
      login_as(@edit_user, :scope => :user)
      @edit_post = Post.create( date: Date.today, rationale: "nfdfnlds", user_id: @edit_user.id )
    end
